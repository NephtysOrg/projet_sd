...
<html><head>
        ...
        <title>INSPINIA | Connexion</title>
    ...
    <body class="gray-bg" cz-shortcut-listen="true">
        ...
        <div class="middle-box text-center loginscreen animated fadeInDown">
            <div>
                ...
                <form:form action="login" commandName="user" cssClass="m-t">
                    ...
                    <a class="btn btn-sm btn-white btn-block" href="<c:url value="/user/create"/>">Créer un compte</a>
                </form:form>
